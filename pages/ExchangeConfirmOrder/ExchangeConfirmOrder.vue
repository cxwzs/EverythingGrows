<template>
	<view class="container" v-if="details">
		...
		<view class="btn">
			<view class="btn-num">
				<text>兑换果实：</text>
				<view>{{details.order_amounts}}颗</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				goods_id: '', //商品id
				quantity: '', //数量
				goods_attr_ids: '', //规格 id串
				goods_attr_desc: '', //规格说明
				adr_id: '', //地址id
				details: '', //订单信息
			};
		},
		onLoad(options) {
			...
			this.goods_attr_ids = data.goods_attr_ids
			this.goods_attr_desc = data.goods_attr_desc
		},
		onShow() {
			let datas = {
