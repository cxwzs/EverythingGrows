<template>
	<view class="container">
		...
		<view class="inp">
			<text>手机号</text>
			<view class="inp-nr">
				<input type="number" v-model="account" placeholder="请输入手机号" placeholder-class="inps" style="width: 50%;" />
				<view class="inp-nr-btn" style="width: 50%;">
					获取微信绑定手机号
				</view>
			</view>
		</view>
		...
		<view class="btn" @click="bindRegister">
			注册
		</view>
		<view class="tips">
			登录注册即表示同意<text>《用户协议》</text>
		</view>
	</view>
</template>
...
<script>
	...
	export default {
		...
		methods: {
			...
			bindRegister() {
				this.$u.debounce(this.registerFunc, 1000, true)
			}
		}
	}
</script>
